//
//  PrependableCollectionProtocol.swift
//  swift-parsing
//
...
/// ```
public protocol PrependableCollectionProtocol<Element>: Collection, _EmptyInitializable, Sendable where Element: Sendable {
...
extension PrependableCollectionProtocol {
	/// Creates a new instance of a collection containing the elements of a sequence.
	///
	/// - Parameter elements: The sequence of elements for the new collection. `elements` must be
	///   finite.
	@inlinable
	public init<S: Collection & Sendable>(_ elements: S) where S.Element == Element, Element: Sendable {
		var collection = Self()
