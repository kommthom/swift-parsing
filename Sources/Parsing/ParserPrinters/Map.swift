...
extension ParserProtocol {
	...
	@_disfavoredOverload
	@inlinable
	public func map<NewOutput: Sendable>(_ transform: @escaping @Sendable(Output) -> NewOutput) -> Parsers.Map<Self, NewOutput> where Self: Sendable {
	...
	@_disfavoredOverload
	@inlinable
	public func map<NewOutput: Sendable>(_ transform: @Sendable () -> NewOutput) -> Parsers.MapConstant<Self, NewOutput> where Self: Sendable {
	...
	/// - Returns: A parser of outputs.
	@inlinable
	public func map<C: Sendable>(_ conversion: C) -> Parsers.MapConversion<Self, C> where Self: Sendable {
...
extension Parsers {
	...
	public struct Map<Upstream: ParserProtocol, NewOutput: Sendable>: ParserProtocol {
		...
		@inlinable
		public init(upstream: Upstream, transform: @escaping @Sendable (Upstream.Output) -> NewOutput) {
	...
	public struct MapConstant<Upstream: ParserProtocol, Output: Sendable>: ParserProtocol where Upstream.Output == Void {
		public let upstream: Upstream
	...
	/// You will not typically need to interact with this type directly. Instead you will usually use
	/// the ``Parser/map(_:)-4hsj5`` operation, which constructs this type.
	public struct MapConversion<Upstream: ParserPrinterProtocol, Downstream: ConversionProtocol>: ParserPrinterProtocol where Downstream.Input == Upstream.Output {
		public let upstream: Upstream
...
extension Parsers.MapConstant: ParserPrinterProtocol where Upstream: ParserPrinterProtocol, Output: Sendable & Equatable {
	@inlinable
