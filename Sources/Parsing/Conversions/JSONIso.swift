...
extension ConversionProtocol {
	...
	@inlinable
	public static func json<Value>(_ type: Value.Type,	decoder: JSONDecoder = .init(),	encoder: JSONEncoder = .init()) -> Self where Self == Conversions.JSONIso<Value> {
	...
	@inlinable
	public func json<Value>(_ type: Value.Type, decoder: JSONDecoder = .init(), encoder: JSONEncoder = .init()) -> Conversions.MapIso<Self, Conversions.JSONIso<Value>> {
...
extension Conversions {
	...
	/// type.
	public struct JSONIso<Value: Sendable & Codable>: ConversionProtocol {
		@usableFromInline
		...
		@inlinable
		public init(_ type: Value.Type, decoder: JSONDecoder = .init(), encoder: JSONEncoder = .init()) {
