...
extension ConversionProtocol {
	...
	public static func formatted<Style>(_ style: Style) -> Self where Self == Conversions.ParseableFormatIso<Style> {
		.init(style: style)
	}
	...
	/// - Returns: A conversion from a string to the given type.
	public func formatted<Style>(_ style: Style) -> Conversions.MapIso<Self, Conversions.ParseableFormatIso<Style>> {
...
extension Conversions {
	...
	/// type.
	@available(iOS 15, macOS 12, tvOS 15, watchOS 8, *)
	public struct ParseableFormatIso<Style: Sendable>: ConversionProtocol where Style: ParseableFormatStyle, Style.FormatInput: Sendable, Style.FormatOutput: Sendable {
