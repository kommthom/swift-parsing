...
extension ConversionProtocol {
	...
	///   given conversion.
	@inlinable
	public func map<C: Sendable>(_ downstream: C) -> Conversions.MapIso<Self, C> {
...
extension Conversions {
	...
	public struct MapIso<Upstream: ConversionProtocol, Downstream: ConversionProtocol>: ConversionProtocol where Upstream.Output == Downstream.Input {
