...
extension ConversionProtocol {
	...
	@inlinable
	public static func representing<NewOutput: Sendable>(_ type: NewOutput.Type) -> Self where Self == Conversions.FromRawValueIso<NewOutput> {
		.init()
	}
	...
	/// - Returns: A conversion from a raw value to the given type.
	@inlinable
	public func representing<NewOutput: Sendable>(_ type: NewOutput.Type) -> Conversions.MapIso<Self, Conversions.FromRawValueIso<NewOutput>> {
...
extension Conversions {
	...
	public struct FromRawValueIso<Output: RawRepresentable & Sendable>: ConversionProtocol where Output.RawValue: Sendable {
		@inlinable
		public init() {}
