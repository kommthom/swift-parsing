...
extension ConversionProtocol {
	...
	@inlinable
	public static func memberwise<Values: Sendable, Struct: Sendable>(_ initializer: @escaping @Sendable (Values) -> Struct) -> Self where Self == Conversions.MemberwiseIso<Values, Struct> {
		.init(initializer: initializer)
	}
}

extension Conversions {
	public struct MemberwiseIso<Values: Sendable, Struct: Sendable>: ConversionProtocol & SendableMarker {
	@usableFromInline
